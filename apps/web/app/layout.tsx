      ...
      <body>
        ...
        <footer className="site-footer">
          <div className="container">
            Apache-2.0 open source. Dual-engine pipeline: MarkItDown fast path, Docling high
            fidelity. Savings math per ADR-003. Token counts are approximate (chars/4) unless an
            exact tokenizer is configured.
          </div>
        </footer>
      </body>
    </html>
